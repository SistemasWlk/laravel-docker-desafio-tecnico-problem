...
(function (m, ma) {
      ...
      (u = b.header[u]) && m.each(u.split(" "), function (oa) {
        ...
        m.each(this.split(","), function (ra, sa) {
          if (sa == "title") {
            ...
            var ha;
            if (a[sa]) ha = a[sa];else if (Ja[sa]) ha = function ha() {
  ...
  function $b(a, b) {
    ...
    function g(c, z) {
      ...
      for (H = 0; H < T.length; H++) {
        X = T[H](c, ca, ka, z);
        if (X === true) return;else if (_typeof(X) == "object") {
          g(X, z);
          return;
        }
      }
    ...
    function sa(c) {
      return (_typeof(c) == "object" ? c.events || c.url : "") || c;
    }
  ...
  function mb(a) {
    ...
    if (_typeof(a) == "object") return a.getHours() * 60 + a.getMinutes();
  ...
  function sc() {
    ...
    function Q(o, s, v) {
      ...
      s.resizable({
        ...
        grid: J,
        start: function start(M, k) {
          F = r = 0;
          i(o, s);
          s.css("z-index", 9);
          fa("eventResizeStart", this, o, M, k);
        },
        resize: function resize(M, k) {
  ...
  function Kb(a, b, e) {
    function d(G, p) {
      G = qa[G];
      if (_typeof(G) == "object") return jb(G, p || e);
      return G;
    }
  ...
  var lc = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
    ...
    ddd: function ddd(a, b) {
      return b.dayNamesShort[a.getDay()];
    },
    dddd: function dddd(a, b) {
    ...
    MMM: function MMM(a, b) {
      return b.monthNamesShort[a.getMonth()];
    },
    MMMM: function MMMM(a, b) {
