...
var guidely = function () {
  return {
    ...
    hideGuides: function hideGuides() {
      $('.guidely-guide').hide();
    },
    showNumbers: function showNumbers() {
      $('.guidely-number').fadeIn('slow');
    },
    hideNumbers: function hideNumbers() {
      $('.guidely-number').hide();
    },
    ...
    _createNumber: function _createNumber(id, options) {
    ...
    _createGuide: function _createGuide(id, options) {
    ...
    _setGuidePosition: function _setGuidePosition(number, content) {
    ...
    _createStartTrigger: function _createStartTrigger() {
      var that = this;
      $('<a>', {
        'href': 'javascript:;',
    ...
    _getCoords: function _getCoords(options) {
    ...
    _getAnchorCoords: function _getAnchorCoords(options) {
    ...
    _createDoneButton: function _createDoneButton() {
      var that = this;
      return $('<button>', {
        text: 'Done',
        click: function click(e) {
    ...
    _scrollToTop: function _scrollToTop(callback) {
    ...
    _createTopAnchor: function _createTopAnchor() {
      $('<div>', {
        id: 'guidely-top'
      }).prependTo('body');
    }
...
/******/ 	__webpack_modules__["./resources/tema/js/guidely/guidely.min.js"]();
/******/ 	
/******/ })()
;